 ...
 *6)emptycol         */
static const char *colors[] = {"#BC5215","#282726","#a02f6f","#66800b","#af3029","#100f0f","#100f0f"};
...
static const uint8_t borders[] = {6,8,2,3};
/* Windows that won't have a border.*/
#define LOOK_INTO "WM_NAME"
static const char *ignore_names[] = {"polybar", "bar", "xclock"};
///--Menus and Programs---///
static const char *menucmd[]   = { "/usr/bin/rofi", "-show", "drun", NULL };
...
static const char *music_fzf[] = { "/home/dino/applications/scripts/mpc-rofi.sh", NULL};
static const char *nvim[]      = { "st", "-e", "nvim", NULL};
static const char *youtube[]   = { "st", "-e", "/home/dino/.local/bin/yt", NULL};
...
static key keys[] = {
    ...
    // Center x:
    {  MOD |CONTROL,      XK_g,          teleport,          {.i=0}},
    // Bottom Right:
    {  MOD ,              XK_n,          teleport,          {.i=2}},
    // Bottom Left:
    {  MOD ,              XK_b,          teleport,          {.i=4}},
    // Top Right:
    {  MOD ,              XK_u,          teleport,          {.i=1}},
    // Top left:
    {  MOD ,              XK_y,          teleport,          {.i=-1}},
    ...
    {  MOD |SHIFT,              XK_period,          nextworkspace,     {.i=0}},
    {  MOD |SHIFT,              XK_comma,          prevworkspace,     {.i=0}},
    ...
    {  MOD ,              XK_c,          start,             {.com = menucmd}},
    {  MOD ,              XK_d,          start,             {.com = dmenu_run}},
    {  MOD |ALT,          XK_b,          start,             {.com = firefox}},
    {  MOD |ALT,          XK_e,          start,             {.com = emacs}},
    {  MOD |ALT,          XK_u,          start,             {.com = urxvt}},
    {  MOD |ALT,          XK_a,          start,             {.com = alacritty}},
    {  MOD |ALT,          XK_r,          start,             {.com = ranger}},
    {  MOD |ALT,          XK_m,          start,             {.com = music_fzf}},
    {  MOD |ALT,          XK_n,          start,             {.com = nvim}},
    {  MOD |ALT,          XK_y,          start,             {.com = youtube}},
    {  ALT |CONTROL,      XK_l,          start,             {.com = lockcmd}},
